...
os.environ['KAGGLE_CONFIG_DIR'] = 'kaggle_path'  # Update this path to your Kaggle configuration directory

# Specify the dataset identifier
dataset = 'paris-2024-olympic-summer-games'

# Set the download path
download_path = 'file_path' # Change this to your preferred download directory
